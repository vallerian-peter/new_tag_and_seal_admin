...
namespace App\Filament\Resources\StageChanges\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('fromStage.name')->label('From Stage')->badge()->toggleable(),
                TextColumn::make('toStage.name')->label('To Stage')->badge()->toggleable(),
            ...
            ->recordActions([
                ActionGroup::make([
                    Action::make('view')
                        ->label('View')
                        ->icon('heroicon-o-eye')
                        ->modalHeading('Stage Change Details')
                        ...
                        ->infolist([
                            ...
                            Section::make('Stage Transition')
                                ->schema([
                                    Grid::make(2)->schema([
                                        TextEntry::make('fromStage.name')->label('From Stage')->badge()->default('—'),
                                        TextEntry::make('toStage.name')->label('To Stage')->badge()->default('—'),
