...
namespace App\Filament\Resources\IdentificationEvents\Tables;
...
class IdentificationEventsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('identificationNumber')->label('Identification Number')->searchable()->badge()->toggleable(),
            ...
            ->recordActions([
                ActionGroup::make([
                    Action::make('view')
                        ->label('View')
                        ->icon('heroicon-o-eye')
                        ->modalHeading('Identification Event Details')
                        ...
                        ->infolist([
                            ...
                            Section::make('Identification Details')
                                ->schema([
                                    Grid::make(2)->schema([
                                        TextEntry::make('identificationNumber')->label('Identification Number')->default('—'),
                                        TextEntry::make('remarks')->label('Remarks')->default('—')->columnSpan(2),
                                    ]),
                                ]),
