...
namespace App\Filament\Resources\LivestockMarkings\Tables;
            ...
            ->recordActions([
                ActionGroup::make([
                    Action::make('view')
                        ->label('View')
                        ->icon('heroicon-o-eye')
                        ->modalHeading('Livestock Marking Details')
                        ...
                        ->infolist([
                            ...
                            Section::make('Marking Details')
                                ->schema([
                                    Grid::make(2)->schema([
                                        TextEntry::make('markingType')->label('Marking Type')->badge(),
                                        TextEntry::make('description')->label('Description')->default('—'),
