...
namespace App\Filament\Resources\IronInjections\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('dosage')->label('Dosage')->badge()->toggleable(),
                TextColumn::make('medicine.name')->label('Medicine')->searchable()->toggleable(),
            ...
            ->recordActions([
                ActionGroup::make([
                    Action::make('view')
                        ->label('View')
                        ->icon('heroicon-o-eye')
                        ->modalHeading('Iron Injection Details')
                        ...
                        ->infolist([
                            ...
                            Section::make('Injection Details')
                                ->schema([
                                    Grid::make(2)->schema([
                                        TextEntry::make('dosage')->label('Dosage')->default('—')->badge(),
                                        TextEntry::make('medicine.name')->label('Medicine')->default('—'),
